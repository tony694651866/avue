        ...
        option: {
          ...
          column: [
            ...
            },
            {
              ...
              type: "select",
              slot: true,
              dicUrl: "/api/origtek-system/sysDict/dictionary?code=user_type",
              props: {
                label: "dictValue",
                value: "dictKey"
              },
            ...
            },
            {
              ...
              column: [
                ...
                },
                {
                  ...
                  multiple: true,
                  type: "tree",
                  dicFlag: true, //dicFlag配置为true，打开表单时候会重新拉去字段
                  dicUrl: "/api/origtek-system/sysRole/tree",
                  props: {
                    label: "title"
                  },
                  checkStrictly: true,
                ...
                },
                {
                  ...
                  multiple: true,
                  dicFlag: true, //dicFlag配置为true，打开表单时候会重新拉去字段
                  dicUrl: "/api/origtek-system/sysDept/tree",
                  props: {
                    label: "title"
                  },
                  checkStrictly: true,
                ...
                },
                {
                  ...
                  multiple: true,
                  dicFlag: true, //dicFlag配置为true，打开表单时候会重新拉去字段
                  dicUrl: "/api/origtek-system/sysPost/select",
                  props: {
                    label: "postName",
                    value: "id"
                  },
